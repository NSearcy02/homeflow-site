        ...
        <div className="mt-16 space-y-16">
          ...
          <section className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <div className="bg-blue-100 text-blue-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-6">
                1
              </div>
          ...
          <section className="flex flex-col lg:flex-row-reverse items-center gap-12">
            <div className="lg:w-1/2">
              <div className="bg-green-100 text-green-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-6">
                2
              </div>
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                System Design & Setup
            ...
            <div className="lg:w-1/2">
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-8 border border-green-100">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Systems We Build:</h3>
                <ul className="space-y-2 text-gray-600">
          ...
          <section className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <div className="bg-purple-100 text-purple-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-6">
                3
              </div>
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Launch & Training
            ...
            <div className="lg:w-1/2">
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-8 border border-purple-100">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Training Includes:</h3>
                <ul className="space-y-2 text-gray-600">
